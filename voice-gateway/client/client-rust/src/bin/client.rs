use voice_gateway_speaker_client::services::audio::config::AudioConfig;
use voice_gateway_speaker_client::services::monitor::kws::KwsMonitor;
use serde_json::json;
use std::time::Duration;
use tokio::time::sleep;
use tokio_tungstenite::connect_async;

use voice_gateway_speaker_client::base::AppError;
use voice_gateway_speaker_client::base::VERSION;
use voice_gateway_speaker_client::services::audio::play::AudioPlayer;
use voice_gateway_speaker_client::services::audio::record::AudioRecorder;
use voice_gateway_speaker_client::services::connect::data::{Event, Request, Response, Stream};
use voice_gateway_speaker_client::services::connect::handler::MessageHandler;
use voice_gateway_speaker_client::services::connect::message::{MessageManager, WsStream};
use voice_gateway_speaker_client::services::connect::rpc::RPC;
use voice_gateway_speaker_client::services::monitor::instruction::InstructionMonitor;
use voice_gateway_speaker_client::services::monitor::playing::PlayingMonitor;
...
async fn run_shell(request: Request) -> Result<Response, AppError> {
    ...
    let res = voice_gateway_speaker_client::utils::shell::run_shell(script.as_str()).await?;
